      ...
      <Modal transparent visible={reviewModal} animationType="slide">
        <View style={styles.modalBg}>
          <View style={styles.modalCard}>
            ...
            <TextInput placeholder="Comment" style={styles.input} multiline value={comment} onChangeText={setComment} />
...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 18, fontWeight: "700", color: "#2cd4c8" },
  ...
  reviewBtnText: { color: "#2cd4c8", fontWeight: "600" },
  ...
  btnOutlineText: { color: "#2cd4c8", fontWeight: "700" },
