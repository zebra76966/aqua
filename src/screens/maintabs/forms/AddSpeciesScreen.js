    ...
    <View style={{ flex: 1, backgroundColor: "#fff" }}>
      ...
      <View style={styles.header}>
        <TouchableOpacity onPress={() => navigation.goBack()}>
          <Ionicons name="arrow-back" size={26} color="#00CED1" />
        </TouchableOpacity>
      ...
      {loadingSpecies ? (
        ...
        <>
          <ScrollView style={{ padding: 20 }}>
            ...
            <TextInput placeholder="Quantity" placeholderTextColor="#2cd4c8" keyboardType="numeric" value={quantity} onChangeText={setQuantity} style={styles.input} />

            <TextInput placeholder="Notes (optional)" placeholderTextColor="#2cd4c8" value={notes} onChangeText={setNotes} style={[styles.input, { height: 100 }]} multiline />
